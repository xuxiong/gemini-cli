...
import {
  IDE_DEFINITIONS,
  detectIdeFromEnv,
} from '@srdcloud/gemini-cli-core/src/ide/detect-ide.js';

vi.mock('@srdcloud/gemini-cli-core/src/ide/detect-ide.js', async () => {
  const actual = await vi.importActual(
    '@srdcloud/gemini-cli-core/src/ide/detect-ide.js',
  );
  return {
    ...actual,
