    ...
    properties: {
      ...
      thirdPartyProvider: {
        ...
        properties: {
          endpoint: {
            type: 'string',
            label: 'Third-Party Provider Endpoint',
            category: 'Model',
            requiresRestart: false,
            default: undefined as string | undefined,
          ...
          apiKey: {
            type: 'string',
            label: 'Third-Party Provider API Key',
            category: 'Model',
            requiresRestart: false,
            default: undefined as string | undefined,
          ...
          model: {
            type: 'string',
            label: 'Third-Party Provider Model',
            category: 'Model',
            requiresRestart: false,
            default: undefined as string | undefined,
            description: 'Default model to use with the third-party provider',
            showInDialog: false,
          },
          name: {
            type: 'string',
            label: 'Third-Party Provider Name',
            category: 'Model',
            requiresRestart: false,
            default: undefined as string | undefined,
            description: 'Display name for the provider configuration',
            showInDialog: false,
          },
          enabled: {
            type: 'boolean',
            label: 'Third-Party Provider Enabled',
            category: 'Model',
            requiresRestart: false,
            default: false,
            description:
              'Whether the third-party provider configuration is currently active',
            showInDialog: false,
          },
        },
      },
