...
import { debugLogger, isGitRepository } from '@srdcloud/gemini-cli-core';
...
export function getInstallationInfo(
  ...
  try {
    ...
    if (realPath.includes('/.pnpm/global')) {
      const updateCommand = 'pnpm add -g @srdcloud/gemini-cli@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @srdcloud/gemini-cli@latest';
      return {
    ...
    if (realPath.includes('/.bun/bin')) {
      const updateCommand = 'bun add -g @srdcloud/gemini-cli@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @srdcloud/gemini-cli@latest';
    return {
