...
vi.mock('@srdcloud/gemini-cli-core', async () => {
  const actual = await vi.importActual('@srdcloud/gemini-cli-core');
  return {
    ...actual,
    uiTelemetryService: {
...
import type { GeminiClient } from '@srdcloud/gemini-cli-core';
import { uiTelemetryService } from '@srdcloud/gemini-cli-core';
